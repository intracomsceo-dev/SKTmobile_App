...
const SECRET_IMAGE_URLS = [
  'https://i.imgur.com/6qQHxlM.png',
  'https://i.imgur.com/IvF3c0A.png',
  'https://i.imgur.com/H7Ccf80.png',
  'https://i.imgur.com/7fTiCgW.png',
  'https://i.imgur.com/v9b6LAb.png',
  'https://i.imgur.com/my2ED57.png'
];
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] font-sans selection:bg-red-100 selection:text-red-900 pb-28 flex flex-col">
      ...
      {/* 하단 고정 바 (Bottom Bar) */}
      {!isAdmin && (
        <div className="fixed bottom-0 left-0 w-full z-50 bg-gradient-to-r from-[#E2000F] to-[#F37321] text-white shadow-[0_-4px_20px_rgba(0,0,0,0.15)] animate-in slide-in-from-bottom duration-500">
          <div className="max-w-6xl mx-auto px-6 py-3 sm:py-4 flex flex-col sm:flex-row justify-between items-center gap-1 sm:gap-4">
            <div className="flex items-center gap-3">
              <span className="text-[10px] sm:text-xs font-black opacity-80 uppercase tracking-tighter">최종 할부원금</span>
              <span className="text-lg sm:text-2xl font-black tracking-tighter">{formatKrw(results.principal)}</span>
            </div>
            <div className="hidden sm:block w-px h-6 bg-white/20"></div>
            <div className="flex items-center gap-3">
              <span className="text-[10px] sm:text-xs font-black opacity-80 uppercase tracking-tighter">24개월 총 소요비용</span>
              <span className="text-lg sm:text-2xl font-black tracking-tighter">{formatKrw(results.total2Year)}</span>
            </div>
          </div>
        </div>
      )}
